 ...
 */
public class CsvConditionDoubleLessEqual implements CsvCondition {
    int field;
    double value;
    String fieldName;
     ...
     * @param value
     */
    public CsvConditionDoubleLessEqual(int field, double value) {
        this(field, value, null);
    }

    public CsvConditionDoubleLessEqual(int field, double value, CsvParser parser) {
        this.field = field;
        this.value = value;
        if (parser == null) {
            fieldName = "[" +field +"]";
