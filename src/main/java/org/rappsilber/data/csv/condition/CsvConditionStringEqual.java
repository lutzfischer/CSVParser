 ...
 */
public class CsvConditionStringEqual implements CsvCondition {
    int field;
    String value;
    String fieldName;
     ...
     * @param value
     */
    public CsvConditionStringEqual(int field, String value) {
        this(field, value, null);
    }

    public CsvConditionStringEqual(int field, String value, CsvParser parser) {
        this.field = field;
        this.value = value;
        if (parser == null) {
            fieldName = "[" +field +"]";
    ...
    public boolean fits(int row, CSVRandomAccess csv) {
        return csv.getValue(field,row).contentEquals(value);
    }
    ...
    public boolean fits(CsvParser csv) {
        return csv.getValue(field).contentEquals(value);
    }
