 ...
 */
public class CsvConditionGreaterField implements CsvCondition {
    int field1;
    int field2;
    String fieldName1;
    String fieldName2;
     ...
     * @param value
     */
    public CsvConditionGreaterField(int field1, int field2) {
        this(field1, field2, null);
    }

    public CsvConditionGreaterField(int field1, int field2, CsvParser parser) {
        this.field1 = field1;
        this.field2 = field2;
        if (parser == null) {
            fieldName1 = "[" +field1 +"]";
